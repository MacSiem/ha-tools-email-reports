/* HA Tools Email Reports bundle v4.2.3 — concatenated from ha-energy-email.js, ha-log-email.js, ha-smart-reports.js (kept in repo for development) */
...
console.info('%c HA Tools — Email & Reports %c v4.2.3 — 3 cards bundled',
